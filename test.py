    ...
    if model_id != 'baselines':
        ...
        with torch.no_grad():
            for x in dataset:
                ...
                imageio.mimsave(f"{out_path}/{rd_point}_enh_video.mp4",output_data.decoded_video, fps=10, codec='libx264')
                imageio.mimsave(f"{out_path}/{rd_point}_viz.mp4",output_data.visualization, codec='libx264',fps=10)
                ...
                imageio.mimsave(f"{out_path}/{rd_point}_anim_enh.mp4",comp_vid, codec='libx264',fps=10)
